...
<body>
    ...
    <div class="container mt-5">
        ...
        <!-- Search Form -->
        <form method="GET" action="display_return_flights.php" class="row justify-content-center g-3">
            <?php
            ...
            while($row = $result->fetch_assoc()) {
                echo "<tr data-id='".$row["id"]."'>
                        ...
                        <td>
                            ...
                            <a href='delete_return_flight.php?id=".$row["id"]."' onclick=\"return confirm('POZOR! Ali ste prepričani za želite izbrisati ta vnos?');\" class='btn btn-danger btn-sm'>Izbriši</a>
                        </td>
                      </tr>";
            }
