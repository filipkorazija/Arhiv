...
<html>
<head>
    <title>MOS Servis - Arhiv 3</title>
    <link rel="stylesheet" type="text/css" href="/utils/style.css?v=1.1">
</head>
<body>
    <?php include('nav.php'); ?>
    <div class="container">
        <h2>Arhiv povratnih letov</h2>

        <!-- Search Form -->
        <form method="GET" action="display_return_flights.php" class="search-form">
            <?php
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                echo "<tr>
                        ...
                        <td>".$row["note"]."</td>
                        <td><a href='delete_return_flight.php?id=".$row["id"]."' onclick=\"return confirm('POZOR! Ali ste prepričani za želite izbrisati ta vnos?');\" class='btn btn-secondary'>Izbriši</a></td>
                      </tr>";
            }
            echo "</tbody></table>";
        } else {
